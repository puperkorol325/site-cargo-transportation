    ...
    return (
        ...
        { isTicketFormOpen && (<TicketForm onCloseTicketForm={handleCloseTicketForm}/>)}
            <div className={['container', isTicketFormOpen ? 'containerFiltered' : ''].join(' ')}>
                <Header2 onOpenTicketForm={handleOpenTicketForm} windowWidth={windowWidth} title='О КОМПАНИИ'/>
                <TextBlock title={aboutUsBlock.title} text={aboutUsBlock.text} imagePath={aboutUsBlock.imagePath}/>
