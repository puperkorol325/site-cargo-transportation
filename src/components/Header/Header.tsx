        ...
        <div className={styles.header}>
            <div className={styles.headerContainer}>
                ...
                <div className={styles.mainInfo}>
                    ...
                    <h2 className={styles.description}>Мы осуществляем перевозки по всей Московской области и Москве со своим автопарком самосвалов и тонаров</h2>
                    <Link to='/about'><CustomizedButton className={styles.aboutUsButton}>О компании</CustomizedButton></Link>
                </div>
            </div>
        </div>
        </>
