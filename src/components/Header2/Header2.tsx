...
export const Header2:React.FC<HeaderProps> = ({ onOpenTicketForm, windowWidth, title }) => {
    return (
        <>
        {windowWidth < 1000 && (<MobileMenu onOpenTicketForm={onOpenTicketForm}/>)}
        {windowWidth > 1000 && (
                        <div className={styles.Navbar}>
                                <Link to={"/"} className={styles.logo}><img src={require('../../img/logo.png')}  alt="Логотип"/></Link>
