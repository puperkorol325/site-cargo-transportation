...
export const MapBlock:React.FC<MapBlockProps> = ({ onOpenTicketForm }) => {
    ...
    return (
        <div className={styles.mapBlock}>
            <iframe className={styles.map} src="https://yandex.ru/map-widget/v1/?um=constructor%3A1441c2f398792d280f1ebb151748958f71588d8a6c96bba39036d405d3d7be00&amp;source=constructor"></iframe>
            <div className={styles.infoContainer}>
                <div className={styles.info}>
                    ...
                    <div className={styles.contactsContainer}>
                        ...
                        <h2 className={styles.email} onClick={() => document.location='mailto:perevozkasamosvaly@gmail.com'}>E-mail: andrey@bastionavto.ru</h2>
